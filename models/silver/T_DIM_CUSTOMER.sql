...
WITH source_data AS (
    SELECT
        CAST(TRIM(C0CST) AS NUMBER(8,0)) AS CUSTOMER_ID,
        CAST(TRIM(C0PCST) AS NUMBER(8,0)) AS PARENT_CUSTOMER_ID,
        CAST(TRIM(C0NAME) AS VARCHAR(40)) AS CUSTOMER_NAME,
        ...
        CAST(TRIM(C0CITY) AS VARCHAR(20)) AS CITY,
        CAST(TRIM(C0STAT) AS VARCHAR(2)) AS STATE_CODE,
        CAST(TRIM(C0ZIP) AS VARCHAR(10)) AS ZIP_CODE,
        CAST(TRIM(C0CNNM) AS VARCHAR(40)) AS CONTACT_NAME,
        ...
        CAST(TRIM(C0CEML) AS VARCHAR(60)) AS CONTACT_EMAIL,
        CAST(TRIM(C0WEBS) AS VARCHAR(60)) AS WEBSITE,
        CAST(TRIM(C0INF1) AS VARCHAR(60)) AS INFO_1,
        CAST(TRIM(C0INF2) AS VARCHAR(60)) AS INFO_2,
        CAST(TRIM(C0INF3) AS VARCHAR(60)) AS INFO_3,
        CAST(TRIM(C0INF4) AS VARCHAR(60)) AS INFO_4,
        CAST(TRIM(C0INF5) AS VARCHAR(60)) AS INFO_5,
        CAST(TRIM(C0SRST) AS NUMBER(3)) AS SALES_REP_STORE,
        CAST(TRIM(C0SLRP) AS NUMBER(5)) AS SALES_REP_ID,
        CAST(TRIM(C0TXCD) AS NUMBER(5)) AS TAX_CODE,
        ...
        CAST(TRIM(C0AGCD) AS VARCHAR(1)) AS AGE_CODE,
        CAST(TRIM(C0PRCD) AS NUMBER(5)) AS PRICE_CODE,
        CAST(TRIM(C0TMCD) AS NUMBER(5)) AS TERMS_CODE,
        CAST(TRIM(C0CRLM) AS NUMBER(9)) AS CREDIT_LIMIT,
        CAST(TRIM(C0BLCD) AS NUMBER(5)) AS BILLING_CODE,
        CAST(TRIM(C0TDCD) AS NUMBER(10)) AS TERMS_DISCOUNT_CODE,
        CAST(TRIM(C0TERR) AS NUMBER(5)) AS TERRITORY_ID,
        CAST(TRIM(C0STORE) AS NUMBER(5)) AS STORE_ID,
        CAST(TRIM(C0APBY) AS VARCHAR(50)) AS APPROVAL_BY,
        CAST(TRIM(C0ACTY) AS NUMBER(3)) AS ACCOUNT_TYPE,
        CAST(TRIM(C0ACDT) AS NUMBER(3)) AS ACCOUNT_TYPE_2,
        ...
        CAST(TRIM(C0PPTP) AS NUMBER(8)) AS PREFERRED_PAYMENT_TYPE,
        CAST(TRIM(C0RVCH) AS NUMBER(9,2)) AS REVOLVING_CHARGE,
        ...
        CAST(TRIM(C0LSAM) AS NUMBER(12,2)) AS LAST_PAYMENT_AMOUNT,
        CAST(TRIM(C0LSTP) AS VARCHAR(30)) AS LAST_PAYMENT_TYPE,
        ...
        -- Generate checksum hash for change tracking
        MD5(CONCAT_WS('|',
