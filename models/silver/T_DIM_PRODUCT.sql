...
WITH SOURCE_DATA AS (
    ...
    SELECT
        ...
        TRIM(I0USER) AS LAST_MAINTAINED_USER,
        TRY_CAST(TRIM(I0CYMD) AS INTEGER) AS LAST_MAINTAINED_DATE,
        TRY_CAST(TRIM(I0HMS) AS INTEGER) AS LAST_MAINTAINED_TIME,
        TRIM(I0WKSN) AS LAST_MAINTAINED_WORKSTATION,
...
JOINED_CHANGES AS (
    ...
    SELECT
        OC.*,
        DC.INVENTORY_CLASS_SK AS CLASS_SK,
        DCAT.INVENTORY_CATEGORY_SK AS CATEGORY_SK
...
EXPIRED_ROWS AS (
    ...
    SELECT
        ...
        EXISTING.LAST_MAINTAINED_USER,
        EXISTING.LAST_MAINTAINED_DATE,
        EXISTING.LAST_MAINTAINED_TIME,
        EXISTING.LAST_MAINTAINED_WORKSTATION,
